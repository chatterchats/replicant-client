...
open_value!(DeviceType { MiningDrone => "mining_drone", MiningController => "mining_controller" });
open_value!(DeviceDirective { GatherResources => "gather_resources", Pause => "pause" });
