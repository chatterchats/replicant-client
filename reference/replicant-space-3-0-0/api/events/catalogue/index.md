...
crawled_at: "2026-09-02T20:03:41.008094+00:00"
---
...
A system hub's capacity dropped below a warning threshold. Fired once per threshold crossing.
...
{
  "capacity": 25.0,
  "warning_type": "wear"       // "wear" or "inactive"
}
```

### *hub.maintained*

A hub repair consumed resources from the hub's location inventory.
...
A mining device automatically moved to another resource site after its current site's resource was depleted. The device continues mining the same resource at the new site.
...
```
{
  ...
  "old_site": "SOL-BELT-1-SITE-0",
  "new_site": "SOL-BELT-1-SITE-3"
}
```
...
Another player's replicant arrived at a star system where you have a replicant present.
...
Another player's replicant departed from a star system where you have a replicant present.
...
```
{
  ...
  "compacted": false,           // true when printed as a flatpack
